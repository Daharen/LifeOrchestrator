...
MemoryResult FileMemoryStore::load_from_disk() {
    ...
    try {
        ...
        snapshot_version_ = entities_by_id_.size() + relationships_by_id_.size() + commitments_by_id_.size() + behavioral_proposals_by_id_.size() + behavioral_state_snapshots_by_id_.size();
