...
public:
    ...
    virtual MemoryResult upsert_schedule_proposal_artifact(const ScheduleProposalArtifact& record) = 0;
    ...
    virtual MemoryResultWith<std::vector<ScheduleProposalArtifact>> list_schedule_proposal_artifacts() const = 0;
    virtual MemoryResultWith<ScheduleProposalArtifact> get_schedule_proposal_artifact_by_id(const ScheduleProposalArtifactId& proposal_id) const = 0;
...
public:
    ...
    MemoryResult upsert_schedule_proposal_artifact(const ScheduleProposalArtifact& record) override;
    ...
    MemoryResultWith<std::vector<ScheduleProposalArtifact>> list_schedule_proposal_artifacts() const override;
    MemoryResultWith<ScheduleProposalArtifact> get_schedule_proposal_artifact_by_id(const ScheduleProposalArtifactId& proposal_id) const override;
...
private:
    ...
    std::unordered_map<ScheduleProposalArtifactId, ScheduleProposalArtifact> schedule_proposal_artifacts_by_id_;
