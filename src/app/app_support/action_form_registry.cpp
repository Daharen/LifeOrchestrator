...
const std::vector<ActionFormSpec>& registry() {
    static const std::vector<ActionFormSpec> specs = {
        ...
        {"run_procedural_audit", "Run Procedural Audit", "procedural-run-audit", {{"procedural_audit_run_id", "Audit Run ID", {"--audit-run-id"}, false, "Optional stable audit lineage id.", "audit.manual"}, {"now", "Timestamp", {"--now"}, false, "Deterministic execution timestamp.", "2026-03-19T09:00:00.000Z"}}, "procedural-run-audit --now 2026-03-19T09:00:00.000Z"},
        {"behavioral_reevaluation", "Behavioral Reevaluation", "behavioral-reevaluate-backlog", {{"now", "Timestamp", {"--now"}, false, "Deterministic execution timestamp.", "2026-03-19T10:00:00.000Z"}}, "behavioral-reevaluate-backlog --now 2026-03-19T10:00:00.000Z"},
        {"generate_scheduling_candidates", "Generate Scheduling Candidates", "scheduling-generate-candidates", {{"now", "Timestamp", {"--now"}, false, "Deterministic execution timestamp.", "2026-03-19T09:00:00.000Z"}}, "scheduling-generate-candidates --now 2026-03-19T09:00:00.000Z"},
        {"generate_schedule_proposals", "Generate Schedule Proposals", "scheduling-generate-proposals", {{"now", "Timestamp", {"--now"}, false, "Deterministic execution timestamp.", "2026-03-19T09:00:00.000Z"}}, "scheduling-generate-proposals --now 2026-03-19T09:00:00.000Z"},
        ...
        {"provider_readiness_test", "Provider Readiness Test", "integration-test-provider", {{"provider_name", "Provider Name", {"--provider-name"}, false, "Optional provider to probe; defaults to configured provider.", "openai"}}, "integration-test-provider --provider-name openai"}};
    return specs;
}
}
