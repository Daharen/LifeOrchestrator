...
const std::vector<ArtifactPresentationSchema>& registry() {
    static const std::vector<ArtifactPresentationSchema> schemas = {
        ...
        {"provider_config_summary", "Provider Config Summary", {field("provider_name", "Provider Name"), field("model_name", "Model Name"), field("secret_source", "Secret Source"), field("api_key_redacted", "API Key")}, {field("credential_reference", "Credential Reference"), field("env_var_name", "Environment Variable")}, {}, "No provider configuration is set.", {action("update_provider_configuration", "Configure Provider", "integration-set-provider"), action("provider_readiness_test", "Provider Readiness Test", "integration-test-provider")}}};
    return schemas;
}
}
